...
@interface PYSearchViewController () <UISearchBarDelegate, UITableViewDelegate, UITableViewDataSource, XBBoxSearchTableViewControllerDelegate>
{
...
- (UITableView *)baseSearchTableView
{
    if (!_baseSearchTableView) {
        UITableView *baseSearchTableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 0, SCREENWIDTH, SCREENHEIGHT-64) style:UITableViewStyleGrouped];
...
- (XBBoxSearchTableViewController *)searchResultController
{
    if (!_searchResultController) {
        _searchResultController = [[XBBoxSearchTableViewController alloc] initWithStyle:UITableViewStyleGrouped];
        _searchResultController.delegate = self;
        self.searchResultTableView = _searchResultController.tableView;
        self.searchResultTableView.frame = CGRectMake(0, 0, SCREENWIDTH, SCREENHEIGHT-64);
    }
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    [MobClick beginLogPageView:@"全搜"];
}

- (void)viewWillDisappear:(BOOL)animated
{
    [super viewWillDisappear:animated];
    [MobClick endLogPageView:@"全搜"];
}
...
- (void)searchBarSearchButtonClicked:(UISearchBar *)searchBar
{
    ...
    switch (self.searchResultShowMode) {
        ...
        case PYSearchResultShowModeEmbed: // 内嵌
            ...
            [self.searchResultController.searchAPIManager loadData];
...
#pragma mark - XBBoxSearchTableViewControllerDelegate
